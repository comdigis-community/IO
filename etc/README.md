...
The audio and video assets provided in this directory are compressed exclusively for testing and demonstration purposes. They are intended to support the included sample applications while keeping the repository distribution as lightweight as possible; accordingly, these media files should not be considered production-quality source assets.
